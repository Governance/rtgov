...
create table RTGOV_ACTIVITY_CONTEXT (ActivityType_unitId varchar(255) not null, ActivityType_unitIndex integer not null, timeframe bigint, type varchar(255), value varchar(255));
