...
public class Activator implements BundleActivator {
    ...
    private org.overlord.rtgov.common.registry.ServiceListener<ActivityStore> _listener;
    
    /**
     * {@inheritDoc}
     */
    public void start(final BundleContext context) throws Exception {
        _listener = new org.overlord.rtgov.common.registry.ServiceListener<ActivityStore>() {
