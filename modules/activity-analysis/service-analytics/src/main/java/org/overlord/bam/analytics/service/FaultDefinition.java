...
/**
 * This class represents a fault within a service operation.
 *
 */
public class FaultDefinition implements java.io.Externalizable {
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof FaultDefinition
                  && ((FaultDefinition)obj).getFault().equals(_fault)) {
            return (true);
        }
