...
| Elasticsearch.ActivityStore.responseSize | Optional maximum size for the response.
| Elasticsearch.ActivityStore.timeout | Optional "best effort" timeout value (milliseconds).
| Elasticsearch.SituationStore.responseSize | Optional maximum size for the response.
| Elasticsearch.SituationStore.timeout | Optional "best effort" timeout value (milliseconds).
|=======================
