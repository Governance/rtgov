...
The simpliest approach is to leverage CDI or OSGi (blueprint) to obtain a reference to the Activity Server.
Once the reference to the Activity Server has been obtained, then the +getActivityTypes+ method can be invoked to
